...
@section('content')
    <div class="mb-6">
        ...
        <h1 class="mt-2 text-2xl font-bold text-gray-900">Tambah Soal Baru</h1>
        <p class="mt-1 text-sm text-gray-500">Isi formulir di bawah untuk menambah soal latihan</p>
    </div>
        ...
        <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-6">
            ...
            <div class="mb-6">
                ...
                <textarea name="question" 
                          ...
                          class="w-full rounded-lg border-gray-300">{{ old('question') }}</textarea>
                @error('question')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="rounded-xl bg-white shadow-sm border border-gray-200 p-6">
            ...
            <div>
                ...
                <textarea name="explanation" 
                          ...
                          class="w-full rounded-lg border-gray-300">{{ old('explanation') }}</textarea>
