        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid gap-12 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <!-- WhatsApp -->
                        <a href="https://wa.me/6285123456789?text=Halo%20Bimbel%20Farmasi,%20saya%20ingin%20bertanya%20tentang%20layanan" target="_blank" class="group flex items-start gap-4 rounded-2xl bg-white p-6 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                        ...
                        <!-- Phone -->
                        <a href="tel:+6285123456789" class="group flex items-start gap-4 rounded-2xl bg-white p-6 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
